...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('like_post', 'Liked your post'), ('like_comment', 'Liked your comment'), ('comment', 'Commented on your post'), ('follow', 'Started following you'), ('mention', 'Mentioned you')], max_length=20)),
